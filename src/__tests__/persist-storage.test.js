...
import { PersistenceManager, createInitialState, getFilterFingerprint } from '../storage/persist-storage';
...
describe('PersistenceManager', () => {
    ...
    test('save and load works correctly', async () => {
        ...
        const newCollapsed = {};
        const success = await persistence.load(newState, newCollapsed, () => ({ start: new Date(2025, 0, 1), end: new Date(2025, 0, 7) }), jest.fn());
