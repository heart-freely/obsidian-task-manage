/**
 * 文件：src/tasks/process/common-process.js
 * 描述：纯工具函数集，不依赖 Obsidian 或 Dataview，提供日期操作、帧节流和简易 DOM 创建等功能
 * 所属模块：tasks/process
 * 依赖：无
 * 对外导出：DateUtils, throttleByFrame, createEl
 * 注意事项：所有函数均为纯工具函数，不涉及任何 Obsidian API 或 Dataview 查询
 */
